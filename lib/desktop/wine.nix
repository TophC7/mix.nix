# Wine application wrapper builder
{ lib }:
{
  # Create a Wine application wrapper with isolated prefix
  #
  # Usage:
  ...
  mkWineApp =
    ...
    let
      ...
      inherit (pkgs) cabextract writeShellScriptBin;
