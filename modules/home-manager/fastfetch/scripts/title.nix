# Title script for fastfetch
# Generates a styled title bar with user, host, and OS info
#
# Usage:
#   title = import ./title.nix { inherit pkgs; };
#   # Then in fastfetch config: "fish ${title}"
#
{ pkgs }:
