...
#   3. Packages backed by flakes may also declare inputs in their argument set.
#   4. It will be automatically picked up and available as packages.my-tool
#
...
lib.fs.importAttrs ./. { inherit lib pkgs inputs; }
